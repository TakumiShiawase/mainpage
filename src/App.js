...
//         // Получение данных с первого URL
//         const decodedToken = jwtDecode(token);
//         const username = decodedToken.username;
//         const webPageResponse = await axios.get(`${apiUrl}/users/api/${username}/`, config);
//         setWebPageSettings(webPageResponse.data);
//         console.log(webPageResponse.data);
//         // Получение данных со второго URL
//         const userResponse = await axios.get('http://127.0.0.1:8000/users/api/settings/user_settings/', config);
...
//   const handleWebPageInputChange = (event) => {
//     const { name, value } = event.target;
//     setWebPageSettings((prevSettings) => ({
//       ...prevSettings,
//       [name]: value,
//     }));
//   };
...
//       // Отправляем данные на первый URL (web_page_settings)
//       await axios.post('http://127.0.0.1:8000/users/api/settings/web_page_settings/', webPageSettings, config);

//       // Отправляем данные на второй URL (user_settings)
//       await axios.post('http://127.0.0.1:8000/users/api/settings/user_settings/', userSettings, config);
...
//         <img alt="#" src={webPageSettings.banner_image} className='banner-img' />
//       </div>
//       <div className="profile-info">
//         <div className='avatar'>
//           <img className='avatar-img' src={webPageSettings.user.profile_img} alt="#" />
//         </div>
//         <div className='user-info'>
//           <div className='user-name'>
//             <div className='first_name'>{userSettings.first_name}</div>
//             <div className='last_name'>{userSettings.last_name}</div>
//           </div>
//           <div className='user-colum'>
//             <div className='user-first__colum'>
//               <div className='user-tag'></div>
//               <div className='user_followers__info'>
//                 <div className='user-followings'>{webPageSettings.followers_count} Followings</div>
//                 <div className='user-followers'>{webPageSettings.following_count} Followers</div>
//               </div>
//               <div className='user-book__info'>
//                 <div className='user-books'>{webPageSettings.books_count} Books</div>
//                 <div className='user-series'>{webPageSettings.series_count} Series</div>
//               </div>
//             </div>
//             <div className='user-second__colum'>
//               <div className='about'>
//                 <div className='about-name'>About</div>
//                 <div className='about-description'>{webPageSettings.about}</div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//                 <div className='avatar_upload'>
//                   <label className='label_avatar' htmlFor="avatar">Upload</label>
//                   <input id="avatar" type="file" name="avatar" accept='image/*' style={{ display: 'none' }} />
//                 </div>
//               </form>
//             </li>
//             <li className='change-li'>
...
//                 <div className='avatar_upload'>
//                   <label className='label_avatar' htmlFor="banner">Upload</label>
//                   <input id="banner" type="file" name="banner" accept='image/*' style={{ display: 'none' }} />
//                 </div>
//               </form>
//             </li>
//             <li className='change-li'>
//               <label htmlFor='firstName' className='change-label'>Firstname</label>
//               <input
//                 type="text"
//                 className='change-input'
//                 id="firstName"
...
//             </li>
//             <li className='change-li'>
//               <label htmlFor='lastName' className='change-label'>Lastname</label>
//               <input
//                 type="text"
//                 className='change-input'
//                 id="lastName"
...
//             <li className='change-li'>
//               <label className='change-label'>Date of Birth Visibility</label>
//               <select className='change-input' name="dobVisibility">
//                 <option value="1">No One</option>
//                 <option value="2">Friends Only(Default)</option>
//                 <option value="3">Everyone</option>
//               </select>
...
//             <li className='change-li'>
//               <label className='change-label'>Gender</label>
//               <select className='change-input' name="gender">
//                 <option value="1">Not Specified</option>
//                 <option value="2">Male</option>
//                 <option value="3">Female</option>
//                 <option value="4">Other</option>
...
//           </span>
//           <Link to="/register" className="create-log">
//             <div className='letter'>Create Account</div>
//           </Link>
...
function StudioBooks() {
  ...
  const updateVisibility = async (bookId, newVisibility) => {
    try {
      ...
      if (response.status === 200) {
        // Обновляем состояние книги в локальном состоянии
        setBooks(books.map(book => book.id === bookId ? {...book, visibility: newVisibility} : book));
      }
    } catch (error) {
  ...
  {book.name}
              ...
              <div className='studio__books_colum'>
                ...
                <select className='studio__books_visiblity_select' value={book.visibility} onChange={(e) => updateVisibility(book.id, e.target.value)}>
...
function StudioSidebarMenu2() {
  ...
  }, [book_id, token]); // useCallback для предотвращения создания новой функции на каждом рендере
  ...
  const handleAddChapter = async () => {
    try {
      ...
      // После успешного добавления главы вызываем заново fetchChapters для обновления списка
      fetchChapters();
    } catch (error) {
        ...
        {chapters.map(chapter => (
          <li className='chapters_studio_maps' key={chapter.id}>
            ...
            >
              {isPublished ? (
                <div className='eye'>
                  <svg fill="#ffffff" width="32px" height="32px" viewBox="0 0 32 32" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsSerif="http://www.serif.com/" xmlnsXlink="http://www.w3.org/1999/xlink">
                ...
                <div className='eye'>
                  <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle cx="12" cy="12" r="3" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              )}
              {chapter.title}
